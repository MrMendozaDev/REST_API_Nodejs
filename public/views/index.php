...
<script src="/app.js?v=0.01"></script>
                ...
                <div class="center">
                    <div class="card col-md-12">
                        ...
                        <div class="row" style="text-align: end;">
                            ...
                            <div class="col-md-12">
                                <button class="btn btn-link float-right border-0" data-toggle="modal" data-target="#recovery_password_modal">  <b > Forgot your password?</b></button>
                            </div>
                            <div class="col-md-12">
                                <button @click="loginUser()" class="btn btn-sm btn-primary mb-1" title="Sign in" ><i class="fas fa-sign-in-alt"></i> Login</button>
                                <!-- <button @click="loginUser" type="button" class="btn btn-sm btn-success">Ligin</button> -->
                            </div>
                        </div>
                    </div>
                </div>
